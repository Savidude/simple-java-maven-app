...
WUMADMIN_EMAIL_SENDER=$ENV_USERNAME
WUMADMIN_JDBC_URL="jdbc:mysql://mysql.storage.cloud.wso2.com:3306/"$WUMADMIN_DB"_"$DB_TENANT"?autoReconnect=true"
WUMADMIN_SP_FULL_URL="$SP_URL"admin
VERSION_SP_FULL_URL="$SP_URL"versions
